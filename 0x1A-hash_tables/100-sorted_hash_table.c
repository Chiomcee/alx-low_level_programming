...
/**
 * Shash_table_get - func that retrieves the value associated with
...
/**
 * shash_table_print - func that prints a sorted hash table in order.
 * @ht: pointer to the sorted hash table.
 */
void shash_table_print(const shash_table_t *ht)
{
...
/**
 * shash_table_delete - func that deletes a sorted hash table.
 * @ht: pointer to the sorted hash table.
 */
void shash_table_delete(shash_table_t *ht)
{
